...
export const initialProjects = [
  ...
  // Upcoming Projects
  {
    id: 2,
    title: 'BrainArena',
    description: 'BrainArena is an AI-powered educational platform where students learn, practice, and compete. By analyzing uploaded study materials, the platform delivers personalized tutoring, automatically generates quizzes and flashcards, and hosts live knowledge tournaments.',
    status: 'upcoming',
    technologies: ['Python', 'Nest.js', 'React', 'typescript','tailwind css','PostgreSQL'],
    image: '👑',
    github: 'https://github.com/irankundaobed/python-generator',
    live: '',
    expectedLaunch: 'late 2026',
    // Detailed information
  overview: 'BrainArena is an AI-powered educational platform where students learn, practice, and compete. By analyzing uploaded study materials, the platform delivers personalized tutoring, automatically generates quizzes and flashcards, and hosts live knowledge tournaments. With real-time leaderboards, achievements, and learning analytics, BrainArena turns studying into an interactive and motivating experience..',
    keyFeatures: [
      'automatic book reading',
      'Drag-and-drop media upload and management',
      'school competitions',
      'student competitions',
      'book explanations and summary',
      'skills challenges',
